...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .titulo-segundo.color-acento-contenido
      h2#t_1_1 1.1 Definición y objetivos del análisis financiero
    ...
    .row.justify-content-center.mb-4(data-aos="flip-up")
      .col-lg-6.mb-3
        .tarjeta-avatar-b.h-100
          ...
          .tarjeta.color1(style= "width: 100%")
            .p-4
              h4 Evaluar la situación económica y financiera
      ...
      .col-lg-6.mb-3
        .tarjeta-avatar-b.h-100
          ...
          .tarjeta.color1(style= "width: 100%")
            .p-4
              h4 Diagnosticar la rentabilidad y eficiencia operativa
      ...
      .col-lg-6.mb-3
        .tarjeta-avatar-b.h-100
          ...
          .tarjeta.color1(style= "width: 100%")
            .p-4
              h4 Analizar la liquidez y solvencia
      ...
      .col-lg-6.mb-3
        .tarjeta-avatar-b.h-100
          ...
          .tarjeta.color1(style= "width: 100%")
            .p-4
              h4 Facilitar la toma de decisiones estratégicas
      ...
      .col-lg-6.mb-3
        .tarjeta-avatar-b.h-100
          ...
          .tarjeta.color1(style= "width: 100%")
            .p-4
              h4 Proyectar escenarios financieros futuros
    ...
    .row.fondo2-t2.justify-content-center.align-items-center.py-3.px-lg-5.px-4.ordenar_tarjeta.mb-4(data-aos="zoom-in")
      ...
      .col-lg-6.order-lg-1.order-2.mb-5(data-aos="fade-right")
        ...
        .tarjeta.BG04.mb-3.p-4(data-aos="fade-down-right")
          ul.lista-ul.mb-0
            ...
            li(style="margin-bottom: 2px")
              i.fas.fa-angle-right
              | ¿Está operando con eficiencia y productividad?
    ...
    p.mb-5(data-aos="fade-down-right") Así como en todo proceso, el análisis financiero tiene sus aspectos positivos, los cuales llevan a un mejor entendimiento de su funcionalidad, destacando lo siguiente:
        ...
        PasosA.color-acento-contenido.mb-5.px-md-5.px-4(tipo="n")
          .row.justify-content-center.align-items-center
            .col-lg-6.order-lg-1.order-2(data-aos="fade-right")
              h3 Facilita la toma de decisiones estratégicas
              p.mb-0 El análisis financiero permite a los directivos y propietarios de una empresa, evaluar su situación económica de manera objetiva. Con base en esta información, pueden tomar decisiones informadas sobre inversión, financiamiento, costos y crecimiento.
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-lg-6(data-aos="fade-left")
              h3 Permite evaluar la rentabilidad y eficiencia
              p.mb-0 A través de indicadores financieros como el ROE (Return on Equity), el ROA (Return on Assets) y los márgenes de utilidad, se puede determinar si la empresa está generando beneficios adecuados en relación con sus recursos y estructura de costos.

          .row.justify-content-center.align-items-center(data-aos="fade-right")
            .col-lg-6.order-lg-1.order-2(data-aos="fade-right")
              h3 Mejora la gestión del riesgo
              p.mb-0 El análisis financiero ayuda a identificar riesgos financieros, operativos y de mercado que pueden afectar la estabilidad de la empresa. Por ejemplo, mediante el análisis de liquidez, se puede evaluar la capacidad de la empresa para cumplir con sus obligaciones de corto plazo.
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-lg-6(data-aos="fade-left")
              h3 Optimiza la gestión del capital de trabajo
              p.mb-0 Permite identificar oportunidades para mejorar la rotación de inventarios, optimizar las cuentas por cobrar y manejar eficientemente las cuentas por pagar, asegurando que la empresa tenga suficiente efectivo para operar sin dificultades.
    ...
    .titulo1.mb-5(data-aos="zoom-in")
      img(src='@/assets/curso/temas/icono.svg', alt='Imagen decorativa')
      h4.mb-0 Limitaciones del análisis financiero

    p.mb-5(data-aos="fade-down-right") Así como existen los aspectos positivos, también hacen presencia los negativos, los cuales se presentan como limitaciones dentro del análisis financiero, destacando lo siguiente:
      ...
      .col-md-6.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h2 1
          h4.text-center 
            b Dependencia de la calidad de la información contable
          p El análisis financiero se basa en la información contable, por lo que, si los datos no son precisos, actualizados o han sido manipulados, los resultados pueden ser erróneos y llevar a decisiones incorrectas.
      ...
      .col-md-6.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-acento-contenido.p-5
          .tarjeta-numerada__numero
            .h2 2
          h4.text-center 
            b No considera factores externos
          p Aunque proporciona una visión detallada de la situación financiera de la empresa, el análisis financiero no siempre tiene en cuenta factores externos como la inflación, cambios en la regulación, el entorno macroeconómico o la competencia.
      ...
      .col-md-6.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-secundario.p-5
          .tarjeta-numerada__numero
            .h2 3
          h4.text-center 
            b Puede ser influenciado por decisiones contables
          p Las empresas pueden utilizar diferentes métodos contables para la valoración de inventarios, amortización de activos y reconocimiento de ingresos, lo que puede afectar la interpretación de los estados financieros y dificultar la comparación entre compañías.
      ...
      .col-md-6.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-acento-botones-especial.p-5
          .tarjeta-numerada__numero
            .h2 4
          h4.text-center 
            b Se basa en datos históricos
          p El análisis financiero utiliza información de períodos anteriores para proyectar el futuro. Sin embargo, las condiciones del mercado, pueden cambiar abruptamente, haciendo que las proyecciones sean menos precisas en escenarios de incertidumbre.
